...
/* --------------------------------------------------------------
   6. ALL COUNTS – FIXED TALENTS IDENTIFIED
   -------------------------------------------------------------- */
$talentsIdentified = getCount($conn, "
...
/* --------------------------------------------------------------
   7. AVERAGE GRADE – ONLY IDENTIFIED TALENTS
   -------------------------------------------------------------- */
$talents_avg = 0;
try {
    $stmt = $conn->prepare("
        ...
        <?php if (in_array($role, ['admin', 'teacher'])): ?>
            ...
            <div class="card stat-card clickable-card" data-bs-toggle="modal" data-bs-target="#talentsModal">
                ...
                <p class="card-text small text-muted mb-0">
                    <span id="talents-avg" class="text-grade-low"></span>
                </p>
            </div>
        <?php endif; ?>
